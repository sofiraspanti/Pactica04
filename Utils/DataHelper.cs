...
namespace Practica04.Utils
{
    public class DataHelper
    {
        ...
        private DataHelper()
        {
            _connection = new SqlConnection("Data Source=210826-013159\\SQLEXPRESS;Initial Catalog=DB_TURNOS;Integrated Security=True;Encrypt=False;Trust Server Certificate=True");
        }
